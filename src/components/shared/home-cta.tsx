...
export function HomeCTA() {
    return (
        <section className="w-full">
            ...
            <div className="w-full h-[400px] relative flex items-center overflow-hidden my-12 group/cta bg-blue-600 rounded-none">
                {/* Decorative pattern */}
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16 text-center lg:text-left">
                        <div className="space-y-6 lg:w-2/3">
                            ...
                            <h2 className="text-4xl md:text-[58px] font-black leading-[1] tracking-tighter uppercase text-white">
                                Impulsá tu carrera en el <br className="hidden md:block" />{" "}
                                sector que mueve al país
                            </h2>
                            <p className="text-base md:text-xl max-w-2xl font-medium leading-relaxed text-white/90">
                        ...
                        <div className="flex flex-col gap-4 items-center lg:items-end">
                            <Link href="/login">
                                <Button
                                    size="lg"
                                    className="h-16 px-10 font-black text-lg rounded-2xl transition-all bg-white bg-gradient-to-b from-white to-zinc-100 text-blue-600 border-none shadow-xl ring-0 active:scale-[0.98] relative overflow-hidden"
                                >
                                    <span className="relative z-10">REGISTRATE GRATIS</span>
                                </Button>
                            </Link>
                            <div className="flex items-center gap-2 text-xs font-bold px-4 py-2 rounded-xl border backdrop-blur-sm bg-blue-700/50 text-white/80 border-white/10">
